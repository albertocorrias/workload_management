...
urlpatterns = [
    ...
    path('accreditation_report/<int:programme_id>/<int:start_year>-<int:end_year>/<int:compulsory_only>/', views.accreditation_report, name='accreditation_report'),
    ...
    path('download_direct_measure_file/<int:measure_id>/', views.download_direct_measure_file, name='download_direct_measure_file'),
