...
from eduload.models import Faculty,Lecturer, Module, TeachingAssignment,WorkloadScenario, ModuleType,\
      Department,EmploymentTrack,ServiceRole,Academicyear, UniversityStaff,TeachingAssignmentType


class TestLecturer(TenantTestCase):
    def setup_user(self):
    ...
    def test_add_lecturer_method(self):
        ...
        #Test the POST now
        self.client.post(reverse('eduload:add_professor',  kwargs={'workloadscenario_id': new_scen.id}),{'name':'bob','fraction_appointment' : '0.5',    \
    ...
    def test_add_remove_professor_method(self):
        ...
        self.client.post(reverse('eduload:add_professor',  kwargs={'workloadscenario_id': new_scen.id}),{'name':'bob','fraction_appointment' : '0.25',    \
                                                                'service_role' : def_role.id, 'employment_track': new_track.id, 'is_external': False,'fresh_record' : True})
        response = self.client.get(reverse('eduload:scenario_view',  kwargs={'workloadscenario_id': new_scen.id}))
        self.assertEqual(response.status_code, 200) #No issues
        ...
        self.client.post(reverse('eduload:remove_professor',  kwargs={'workloadscenario_id': new_scen.id}), {'select_professor_to_remove': all_profs[0].id, 'wipe_out_from_table' : True})
        response = self.client.get(reverse('eduload:scenario_view',  kwargs={'workloadscenario_id': new_scen.id}))
        self.assertEqual(response.status_code, 200) #No issues
    ...
    def test_add_lecturer_same_name(self):
        ...
        #Now add Bob again
        response = self.client.post(reverse('eduload:add_professor',  kwargs={'workloadscenario_id': new_scen.id}),{'name':'bob','fraction_appointment' : '0.5',    \
                                                                            'service_role' : def_role.id,'employment_track': new_track.id,'is_external': False,'fresh_record' : True})        
        ...
        response = self.client.get(reverse('eduload:scenario_view',  kwargs={'workloadscenario_id': scen_2.get().id}))
        
        #add now
        response = self.client.post(reverse('eduload:add_professor',  kwargs={'workloadscenario_id': scen_2.get().id}),{'name':'bob','fraction_appointment' : '0.5',   \
                                                                            'service_role' : def_role.id,'employment_track': new_track.id, 'is_external': False,'fresh_record' : True})        
        ...
        response = self.client.post(reverse('eduload:add_professor',  kwargs={'workloadscenario_id': scen_2.get().id}),{'name':'bob_external','fraction_appointment' : '0.5',   \
    ...
    def test_edit_existing_lecturer(self):
        ...
        self.client.post(reverse('eduload:add_professor',  kwargs={'workloadscenario_id': new_scen.id}),{'name':'bob','fraction_appointment' : '0.7',    \
                                                                'service_role' : def_role.id,'employment_track': new_track.id, 'is_external': False,'fresh_record' : True})
        self.client.post(reverse('eduload:add_professor',  kwargs={'workloadscenario_id': new_scen.id}),{'name':'fred','fraction_appointment' : '0.5',    \
                                                                'service_role' : def_role.id,'employment_track': new_track.id, 'is_external': False,'fresh_record' : True})
        ...
        self.client.post(reverse('eduload:add_assignment',  kwargs={'workloadscenario_id': new_scen.id}), data = {'select_lecturer': obtained_profs_list.filter(name='bob').get().id, \
        ...
        response = self.client.post(reverse('eduload:add_professor',  kwargs={'workloadscenario_id': new_scen.id}),{'name':'bob','fraction_appointment' : '0.7',    \
        ...
        response = self.client.post(reverse('eduload:add_professor',  kwargs={'workloadscenario_id': new_scen.id}),{'name':'bob','fraction_appointment' : '1.5',    \
                                                                            'service_role' : def_role.id,'employment_track': new_track.id,'is_external': False, 'fresh_record' : False})
        response = self.client.get(reverse('eduload:scenario_view',  kwargs={'workloadscenario_id': new_scen.id}))
        self.assertEqual(response.status_code, 200) #No issues
    ...
    def test_edit_existing_lecturer_different_scenarios(self):
        ...
        #Test the POST
        self.client.post(reverse('eduload:add_professor',  kwargs={'workloadscenario_id': scenario_1.id}),{'name':'bob','fraction_appointment' : '0.7',    \
                                                                'service_role' : def_role.id,'employment_track': new_track.id,'is_external': False,'fresh_record' : True})
        self.client.post(reverse('eduload:add_professor',  kwargs={'workloadscenario_id': scenario_1.id}),{'name':'fred','fraction_appointment' : '0.5',    \
                                                                'service_role' : def_role.id,'employment_track': new_track.id,'is_external': False,'fresh_record' : True})
        ...
        acad_year = Academicyear.objects.create(start_year=2200)
        self.client.post(reverse('eduload:manage_scenario'), {'label': scen_name_2, 'dept' : first_dept.id, 'copy_from': scenario_1.id, 'status': WorkloadScenario.DRAFT, 'fresh_record' : True, 'academic_year' : acad_year.id});
        ...
        response = self.client.post(reverse('eduload:add_professor',  kwargs={'workloadscenario_id': scenario_2.id}),{'name':'bob','fraction_appointment' : '0.7',    \
                                                                            'service_role' : def_role.id,'employment_track': new_track.id, 'is_external': False, 'fresh_record' : False})
        response = self.client.get(reverse('eduload:scenario_view',  kwargs={'workloadscenario_id': scenario_2.id}))
        self.assertEqual(response.status_code, 200) #No issues
        obtained_profs_list = Lecturer.objects.all()
    ...
    def test_remove_prof_with_assignments(self):
        ...
        self.client.post(reverse('eduload:add_professor',  kwargs={'workloadscenario_id': scenario_2.id}),{'name':'normal_lecturer','fraction_appointment' : '0.7',    'service_role' : def_role.id, 'employment_track': new_track.id,'is_external': False,'fresh_record' : True})
        self.client.post(reverse('eduload:add_professor',  kwargs={'workloadscenario_id': scenario_2.id}),{'name':'educator_track','fraction_appointment' : '1.0',    'service_role' : def_role.id,'employment_track': new_track.id,'is_external': False,'fresh_record' : True})
        self.client.post(reverse('eduload:add_professor',  kwargs={'workloadscenario_id': scenario_2.id}),{'name':'vice_dean','fraction_appointment' : '0.5',    'service_role' : def_role.id,'employment_track': new_track.id,'is_external': False,'fresh_record' : True})
        ...
        #Now remove one that had modules assigned
        self.client.post(reverse('eduload:remove_professor',  kwargs={'workloadscenario_id': scenario_2.id}), {'select_professor_to_remove': educator_track.id,'wipe_out_from_table' : False})
        response = self.client.get(reverse('eduload:scenario_view',  kwargs={'workloadscenario_id': scenario_2.id}))
        self.assertEqual(response.status_code, 200) #No issues
        all_profs = Lecturer.objects.all()
        ...
        self.client.post(reverse('eduload:add_professor',  kwargs={'workloadscenario_id': scenario_1.id}),{'name':'educator_track',\
        ...
        self.client.post(reverse('eduload:remove_professor',  kwargs={'workloadscenario_id': scenario_1.id}), {'select_professor_to_remove': educator_track.id,'wipe_out_from_table' : False})
        response = self.client.get(reverse('eduload:scenario_view',  kwargs={'workloadscenario_id': scenario_1.id}))
        self.assertEqual(response.status_code, 200) #No issues
        teaching_assignments = TeachingAssignment.objects.all()
    ...
    def test_upload_lecturers_in_bulk(self):
        ...
        response = self.client.post(reverse('eduload:bulk_add_professor',  kwargs={'workload_id': scenario_1.id}),\
