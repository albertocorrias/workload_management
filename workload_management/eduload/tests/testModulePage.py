...
from eduload.models import StudentLearningOutcome, ProgrammeOffered, Faculty, Department, Academicyear,WorkloadScenario,EmploymentTrack,ServiceRole,\
...
class TestModulePage(TenantTestCase):
    def setup_user(self):
    ...
    def test_module_page(self):
        ...
        response = self.client.get(reverse('eduload:module',  kwargs={'module_code': "BN301"}))
        ...
        response = self.client.get(reverse('eduload:module',  kwargs={'module_code': "BN301TT"}))
    ...
    def test_add_remove_mlo(self):
        ...
        response = self.client.get(reverse('eduload:module', kwargs={'module_code': module_1.module_code}))
        self.assertEqual(response.status_code, 200) #No issues
        ...
        response = self.client.post(reverse('eduload:module', kwargs={'module_code': module_1.module_code}), \
