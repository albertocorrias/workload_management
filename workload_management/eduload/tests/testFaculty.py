...
from decimal import *
from eduload.models import Department, Faculty, UniversityStaff

class TestFaculty(TenantTestCase):
    def setup_user(self):
    ...
    def test_add_remove_faculty(self):
        ...
        #Remove faculty
        self.client.post(reverse('eduload:remove_faculty'),{'select_faculty_to_remove':new_fac_object.get().id})
    ...
    def test_add_remove_with_departments(self):
        ...
        self.client.post(reverse('eduload:manage_department'), {'department_name': 'test_dept', 'department_acronym' : 'TD3', \
    ...
    def test_edit_existing_faculty(self):
        ...
        fac_code_1 = 'NN'
        #add  one
        self.client.post(reverse('eduload:manage_faculty'),{'faculty_name':fac_name_1, 'faculty_acronym' : fac_code_1, 'fresh_record' : True})
        self.assertEqual(Faculty.objects.all().count(),1) 
        ...
        self.client.post(reverse('eduload:manage_faculty'),{'faculty_name':new_name, 'faculty_acronym' : fac_code_1, \
                                                              'fresh_record' : False,
                                                              "fac_id" : fac_id})
        self.assertEqual(Faculty.objects.all().count(),1) 
        ...
        #Edit the acronym
        new_acronym = "TT"
        self.client.post(reverse('eduload:manage_faculty'),{'faculty_name':new_name, 'faculty_acronym' : new_acronym, \
                                                              'fresh_record' : False,
                                                              "fac_id" : fac_id})
        self.assertEqual(Faculty.objects.all().count(),1) 
        self.assertEqual(Faculty.objects.filter(faculty_name = fac_name_1).count(), 0)#Old name is gone
    ...
    def test_edit_faculty_into_same_name(self):
        ...
        fac_code_2 = 'RR'
        self.client.post(reverse('eduload:manage_faculty'),{'faculty_name':fac_name_2, 'faculty_acronym' : fac_code_2, 'fresh_record' : True})
        #Check we added
        ...
        self.client.post(reverse('eduload:manage_faculty'),{'faculty_name':fac_name_1, 'faculty_acronym' : fac_code_2, \
                                                              'fresh_record' : False,
                                                              "fac_id" : fac_id})
