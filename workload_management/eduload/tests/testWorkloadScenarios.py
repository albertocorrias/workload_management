...
from decimal import *
from eduload.models import Academicyear, Lecturer, Module, \
    TeachingAssignment,WorkloadScenario,ModuleType,Department, EmploymentTrack, ServiceRole,Faculty,ProgrammeOffered, UniversityStaff,\
    TeachingAssignmentType


class TestWorkloadScenarios(TenantTestCase):
    def setup_user(self):
    ...
    def test_add_remove_scenario_forms(self):
        ...
        response = self.client.get(reverse('eduload:scenario_view',  kwargs={'workloadscenario_id': first_scenario.id}))
        self.assertEqual(response.status_code, 200) #No issues
        ...
        self.client.post(reverse('eduload:add_professor',  kwargs={'workloadscenario_id': first_scenario.id}),{'name':'bob','fraction_appointment' : '0.5',    'service_role' : new_role.id, 'employment_track': new_track.id, 'is_external': False,'fresh_record' : True})
        self.client.post(reverse('eduload:add_module',  kwargs={'workloadscenario_id': first_scenario.id}), 
                                                                      {'module_code': "BN112", \
                                                                       'module_title' : 'testing_unused',\
                                                                       'total_hours' : '234',\
        ...
        self.client.post(reverse('eduload:manage_scenario'),{'label':new_label, 'dept' : first_dept.id, 'fresh_record' : True, \
        ...
        mod_code = 'AA111'
        self.client.post(reverse('eduload:add_professor',  kwargs={'workloadscenario_id': new_scenario.get().id}),{'name':'bob','fraction_appointment' : '0.5',    'service_role' : new_role.id, 'employment_track': new_track.id, 'is_external': False, 'fresh_record' : True})
        self.client.post(reverse('eduload:add_module', kwargs={'workloadscenario_id': new_scenario.get().id}), {
            'module_code': mod_code, 'module_title' : 'testing', 'total_hours' : '234', 'module_type' : mod_type_1.id, 
                                    'students_year_of_study' :2,
                                    'semester_offered' : Module.UNASSIGNED,
                                    'compulsory_in_primary_programme' : False,
                                    'compulsory_in_secondary_programme':  False,
                                    'compulsory_in_tertiary_programme': False,   'fresh_record' : True})    
        ...
        self.client.post(reverse('eduload:add_assignment',  kwargs={'workloadscenario_id': new_scenario.get().id}), data = {'select_lecturer': normal_lecturer.id, \
                 'select_module': module_1.id, 'teaching_assignment_type' : assignment_type.id, 'counted_towards_workload' : 'yes','how_many_units':'136'})
        ...
        self.client.post(reverse('eduload:remove_scenario'), {'select_scenario_to_remove': WorkloadScenario.objects.filter(label=new_label).get().id})
        response = self.client.get(reverse('eduload:workloads_index'))
        self.assertEqual(response.status_code, 200) #No issues
    ...
    def test_manage_scenario(self):
        ...
        self.client.post(reverse('eduload:add_module', kwargs={'workloadscenario_id': first_scenario.id}), {'module_code': mod_code_1, 'module_title' : 'testing', 'total_hours' : '2340', 'module_type' : mod_type_1.id, 'semester_offered' : Module.UNASSIGNED,  'students_year_of_study' :2, 'compulsory_in_primary_programme' : False, 'compulsory_in_secondary_programme':  False, 'compulsory_in_tertiary_programme': False,  'fresh_record' : True})    
        self.client.post(reverse('eduload:add_module', kwargs={'workloadscenario_id': first_scenario.id}), {'module_code': mod_code_2, 'module_title' : 'testing2', 'total_hours' : '234', 'module_type' : mod_type_1.id, 'semester_offered' : Module.UNASSIGNED,  'students_year_of_study' :2, 'compulsory_in_primary_programme' : False, 'compulsory_in_secondary_programme':  False, 'compulsory_in_tertiary_programme': False,  'fresh_record' : True})    
        self.client.post(reverse('eduload:add_module', kwargs={'workloadscenario_id': first_scenario.id}), {'module_code': mod_code_3, 'module_title' : 'testing3', 'total_hours' : '234', 'module_type' : mod_type_1.id, 'semester_offered' : Module.UNASSIGNED,  'students_year_of_study' :2, 'compulsory_in_primary_programme' : False, 'compulsory_in_secondary_programme':  False, 'compulsory_in_tertiary_programme': False,  'primary_programme' : first_prog.id, 'fresh_record' : True})    
        ...
        self.client.post(reverse('eduload:add_assignment',  kwargs={'workloadscenario_id': first_scenario.id}), data = {'select_lecturer': normal_lecturer.id, \
                 'select_module': module_1.get().id, 'teaching_assignment_type' : assignment_type.id, 'counted_towards_workload' : 'yes','how_many_units':'16'})
        ...
        self.client.post(reverse('eduload:add_assignment',  kwargs={'workloadscenario_id': first_scenario.id}), data = {'select_lecturer': educator_track.id, \
                 'select_module': module_2.get().id, 'teaching_assignment_type' : assignment_type.id, 'counted_towards_workload' : 'no','how_many_units':'582'})
        ...
        self.client.post(reverse('eduload:manage_scenario'), {'label': new_label, 'dept' : first_dept.id, 'copy_from':first_scenario.id, \
        ...
        self.client.post(reverse('eduload:manage_scenario'), {'label': third_scen_label, 'dept' : first_dept.id, 'copy_from':'', \
                                                                        'status': WorkloadScenario.DRAFT,'fresh_record' :  True,'academic_year' : acad_year.id});
        response = self.client.get(reverse('eduload:workloads_index'))
        self.assertEqual(response.status_code, 200) #No issues
        ...
        self.client.post(reverse('eduload:remove_scenario'), {'select_scenario_to_remove': new_scenario.id})
        response = self.client.get(reverse('eduload:workloads_index'))
        self.assertEqual(response.status_code, 200) #No issues
    ...
    def test_manage_scenario_same_name(self):
        ...
        self.client.post(reverse('eduload:manage_scenario'), {'label': first_scen_label, 'dept' : first_dept.id,  'copy_from': '',\
    ...
    def test_edit_existing_scenario(self):
        ...
        new_name = 'hello'
        self.client.post(reverse('eduload:manage_scenario'), {'label': new_name, 'dept' : first_dept.id,\
    ...
    def test_edit_scenario_into_existing_name(self):
        ...
        self.client.post(reverse('eduload:manage_scenario'), {'label': new_name, 'dept' : first_dept.id, 'copy_from': '', 
        ...
        self.client.post(reverse('eduload:manage_scenario'), {'label': first_scen_label, 'dept' : first_dept.id,\
    ...
    def test_multiple_scenarios(self):
        ...
        #response = self.client.get(reverse('eduload:index'))
        ...
        self.client.post(reverse('eduload:add_assignment',  kwargs={'workloadscenario_id': scenario_1.id}), data = {'select_lecturer': educator_track_scen_1.id, \
                 'select_module': module_2_scen_1.id, 'teaching_assignment_type' : assignment_type.id, 'counted_towards_workload' : 'yes','how_many_units':'56'})
        ...
        self.client.post(reverse('eduload:remove_assignment',  kwargs={'workloadscenario_id': scenario_2.id}), {'select_teaching_assignment_to_remove': teaching_assignments_for_active_scenario[0].id})
    ...
    def test_scenario_status(self):
        ...
        self.client.post(reverse('eduload:manage_scenario'),{'label':first_label, 'dept' : first_dept.id, 'fresh_record' : True, \
        ...
        self.client.post(reverse('eduload:manage_scenario'),{'label':second_label, 'dept' : first_dept.id, 'fresh_record' : True, \
        ...
        self.client.post(reverse('eduload:manage_scenario'),{'scenario_id' : new_scen_obj.id, 'label':second_label, 'dept' : first_dept.id, 'fresh_record' : False, \
                                                                    'status': WorkloadScenario.DRAFT, 'academic_year' : acad_year.id})
        ...
        self.client.post(reverse('eduload:manage_scenario'),{'label':third_label, 'dept' : second_dept.id, 'fresh_record' : True, \
                                                                    'status': WorkloadScenario.OFFICIAL, 'academic_year' : acad_year.id})
        self.assertEqual(WorkloadScenario.objects.filter(status=WorkloadScenario.DRAFT).count(),2)
        self.assertEqual(WorkloadScenario.objects.filter(status=WorkloadScenario.OFFICIAL).count(),1)
        ...
        self.client.post(reverse('eduload:manage_scenario'),{'scenario_id' : first_scen_obj.id, 'label':first_label, 'dept' : first_dept.id, 'fresh_record' : False, \
                                                                    'status': WorkloadScenario.OFFICIAL, 'academic_year' : acad_year.id})
        self.assertEqual(WorkloadScenario.objects.filter(status=WorkloadScenario.DRAFT).count(),1)
        ...
        self.client.post(reverse('eduload:manage_scenario'),{'label':fourth_label, 'dept' : first_dept.id, 'fresh_record' : True, \
                                                                    'status': WorkloadScenario.DRAFT, 'academic_year' : acad_year.id})
