...
from eduload.models import Lecturer, TeachingAssignment, TeachingAssignmentType, WorkloadScenario, Department, EmploymentTrack, ServiceRole, UniversityStaff, Faculty,Academicyear


class TestTeachingAssignmentType(TenantTestCase):
    def setup_user(self):
    ...
    def test_add_remove_edit_type(self):
        ...
        num_hrs = 12
        self.client.post(reverse('eduload:school_page' ,  kwargs={'faculty_id': new_fac.id}),\
        ...
        self.client.post(reverse('eduload:school_page',  kwargs={'faculty_id': new_fac.id}),{'select_assignment_type_to_remove':ass_type_obj.id})
