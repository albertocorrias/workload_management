...
from eduload.models import StudentLearningOutcome, ProgrammeOffered, Faculty, Department, ProgrammeEducationalObjective,PEOSLOMapping, Academicyear, Survey,UniversityStaff


class TestAccreditation(TenantTestCase):
    def setup_user(self):
    ...
    def test_add_remove_slo_and_peo(self):
        ...
        response = self.client.post(reverse('eduload:accreditation',  kwargs={'programme_id': new_prog.id}),
