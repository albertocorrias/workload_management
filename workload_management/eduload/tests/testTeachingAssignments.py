...
from decimal import *
from eduload.models import Faculty,Lecturer, Module, TeachingAssignment,WorkloadScenario,\
    ModuleType,Department,EmploymentTrack,ServiceRole,Academicyear, UniversityStaff,TeachingAssignmentType
from eduload.global_constants import DEFAULT_WORKLOAD_NAME,CalculateNumHoursBasedOnWeeklyInfo

class TestTeachingAssignments(TenantTestCase):
    def setup_user(self):
    ...
    def test_add_delete_teaching_assignment(self):
        ...
        self.client.post(reverse('eduload:remove_assignment',  kwargs={'workloadscenario_id': new_scen.id}), {'select_teaching_assignment_to_remove': ta.id})
        response = self.client.get(reverse('eduload:scenario_view',  kwargs={'workloadscenario_id': new_scen.id}))
    ...
    def test_add_teaching_assignment_same_prof_same_mod(self):
        ...
        mod_code_1 = 'AS101'
        self.client.post(reverse('eduload:add_module',  kwargs={'workloadscenario_id': new_scen.id}), {'module_code': mod_code_1, 'module_title' : 'module 1', 'students_year_of_study' :2, 'compulsory_in_primary_programme' : False, 'compulsory_in_secondary_programme':  False, 'compulsory_in_tertiary_programme': False, 'total_hours' : '234', 'module_type' : mod_type_1.id, 'semester_offered' : Module.UNASSIGNED,   'fresh_record' : True})    
    ...
    def test_edit_lecturer_assignments(self):
        ...
        assignment_type = TeachingAssignmentType.objects.create(description="hours", quantum_number_of_hours=1,faculty=new_fac)
        self.client.post(reverse('eduload:add_assignment',  kwargs={'workloadscenario_id': scenario_1.id}), {'select_lecturer': normal_lecturer.id, 'select_module': module_1.id, 'teaching_assignment_type' : assignment_type.id, 'counted_towards_workload' : 'yes','how_many_units':'16'});
        self.client.post(reverse('eduload:add_assignment',  kwargs={'workloadscenario_id': scenario_1.id}), {'select_lecturer': educator_track.id, 'select_module': module_2.id, 'teaching_assignment_type' : assignment_type.id, 'counted_towards_workload' : 'yes','how_many_units':'26'});
        self.client.post(reverse('eduload:add_assignment',  kwargs={'workloadscenario_id': scenario_1.id}), {'select_lecturer': vice_dean.id, 'select_module': module_3.id, 'teaching_assignment_type' : assignment_type.id, 'counted_towards_workload' : 'yes','how_many_units':'36'});        
        self.client.post(reverse('eduload:add_assignment',  kwargs={'workloadscenario_id': scenario_1.id}), {'select_lecturer': vice_dean.id, 'select_module': module_2.id, 'teaching_assignment_type' : assignment_type.id, 'counted_towards_workload' : 'no','how_many_units':'46'});        
        ...
        self.client.post(reverse('eduload:edit_lecturer_assignments', kwargs={'prof_id':prof_id}),\
    ...
    def test_edit_assignment_with_zero_hours(self):
        ...
        self.client.post(reverse('eduload:add_module',  kwargs={'workloadscenario_id': scenario_1.id}), {'module_code': mod_code_1, 'module_title' : 'module 1', 'total_hours' : '234', 'module_type' : mod_type_1.id, 'semester_offered' : Module.UNASSIGNED,  'students_year_of_study' :2,'compulsory_in_primary_programme' : False, 'compulsory_in_secondary_programme':  False, 'compulsory_in_tertiary_programme': False, 'fresh_record' : True})    
        self.client.post(reverse('eduload:add_module',  kwargs={'workloadscenario_id': scenario_1.id}), {'module_code': mod_code_2, 'module_title' : 'module 2', 'total_hours' : '234', 'module_type' : mod_type_1.id, 'semester_offered' : Module.UNASSIGNED,  'students_year_of_study' :2,'compulsory_in_primary_programme' : False, 'compulsory_in_secondary_programme':  False, 'compulsory_in_tertiary_programme': False, 'fresh_record' : True})    
        self.client.post(reverse('eduload:add_module',  kwargs={'workloadscenario_id': scenario_1.id}), {'module_code': mod_code_3, 'module_title' : 'module 3', 'total_hours' : '234', 'module_type' : mod_type_1.id, 'semester_offered' : Module.UNASSIGNED,  'students_year_of_study' :2,'compulsory_in_primary_programme' : False, 'compulsory_in_secondary_programme':  False, 'compulsory_in_tertiary_programme': False, 'fresh_record' : True})    
        self.assertEqual(Module.objects.all().count(),3)
        ...
        self.client.post(reverse('eduload:add_assignment',  kwargs={'workloadscenario_id': scenario_1.id}), {'select_lecturer': normal_lecturer.id, 'select_module': module_1.id, 'teaching_assignment_type' : assignment_type.id, 'counted_towards_workload' : 'yes','how_many_units':'16'});
        self.client.post(reverse('eduload:add_assignment',  kwargs={'workloadscenario_id': scenario_1.id}), {'select_lecturer': educator_track.id, 'select_module': module_2.id, 'teaching_assignment_type' : assignment_type.id, 'counted_towards_workload' : 'yes','how_many_units':'26'});
        self.client.post(reverse('eduload:add_assignment',  kwargs={'workloadscenario_id': scenario_1.id}), {'select_lecturer': educator_track.id, 'select_module': module_3.id,'teaching_assignment_type' : assignment_type.id, 'counted_towards_workload' : 'yes','how_many_units':'126'});        
        self.client.post(reverse('eduload:add_assignment',  kwargs={'workloadscenario_id': scenario_1.id}), {'select_lecturer': vice_dean.id, 'select_module': module_3.id,'teaching_assignment_type' : assignment_type.id, 'counted_towards_workload' : 'yes','how_many_units':'36'});        
        self.client.post(reverse('eduload:add_assignment',  kwargs={'workloadscenario_id': scenario_1.id}), {'select_lecturer': vice_dean.id, 'select_module': module_2.id, 'teaching_assignment_type' : assignment_type.id, 'counted_towards_workload' : 'yes','how_many_units':'46'});        
    ...
    def test_edit_module_assignments(self):
        ...
        mod_code_2 = 'AS201'
        mod_code_3 = 'AS301'
        self.client.post(reverse('eduload:add_module',  kwargs={'workloadscenario_id': scenario_1.id}), {'module_code': mod_code_1, 'module_title' : 'module 1', 'total_hours' : '234', 'module_type' : mod_type_1.id, 'students_year_of_study' :2, 'semester_offered' : Module.UNASSIGNED,  'compulsory_in_primary_programme' : False, 'compulsory_in_secondary_programme':  False, 'compulsory_in_tertiary_programme': False,  'fresh_record' : True})    
        self.client.post(reverse('eduload:add_module',  kwargs={'workloadscenario_id': scenario_1.id}), {'module_code': mod_code_2, 'module_title' : 'module 2', 'total_hours' : '234', 'module_type' : mod_type_1.id, 'students_year_of_study' :2, 'semester_offered' : Module.UNASSIGNED,  'compulsory_in_primary_programme' : False, 'compulsory_in_secondary_programme':  False, 'compulsory_in_tertiary_programme': False,  'fresh_record' : True})    
        self.client.post(reverse('eduload:add_module',  kwargs={'workloadscenario_id': scenario_1.id}), {'module_code': mod_code_3, 'module_title' : 'module 3', 'total_hours' : '234', 'module_type' : mod_type_1.id, 'students_year_of_study' :2, 'semester_offered' : Module.UNASSIGNED,  'compulsory_in_primary_programme' : False, 'compulsory_in_secondary_programme':  False, 'compulsory_in_tertiary_programme': False,  'fresh_record' : True})    
        self.assertEqual(Module.objects.all().count(),3)
        ...
        assignment_type = TeachingAssignmentType.objects.create(description="hours", quantum_number_of_hours=1,faculty=new_fac)
        self.client.post(reverse('eduload:add_assignment',  kwargs={'workloadscenario_id': scenario_1.id}), {'select_lecturer': normal_lecturer.id, 'select_module': module_1.id, 'teaching_assignment_type' : assignment_type.id, 'counted_towards_workload' : 'yes','how_many_units':'16'});
        self.client.post(reverse('eduload:add_assignment',  kwargs={'workloadscenario_id': scenario_1.id}), {'select_lecturer': educator_track.id, 'select_module': module_3.id,'teaching_assignment_type' : assignment_type.id, 'counted_towards_workload' : 'yes','how_many_units':'26'});        
        self.client.post(reverse('eduload:add_assignment',  kwargs={'workloadscenario_id': scenario_1.id}), {'select_lecturer': vice_dean.id, 'select_module': module_3.id, 'teaching_assignment_type' : assignment_type.id, 'counted_towards_workload' : 'yes','how_many_units':'36'});        
        self.client.post(reverse('eduload:add_assignment',  kwargs={'workloadscenario_id': scenario_1.id}), {'select_lecturer': vice_dean.id, 'select_module': module_2.id, 'teaching_assignment_type' : assignment_type.id, 'counted_towards_workload' : 'yes','how_many_units':'46'});        
        ...
        #NOW edit the assignment. Key change simulated: 145 hours for vice_dean teaching AS301 (editing from 36)
        self.client.post(reverse('eduload:edit_module_assignments',kwargs={'module_id':module_id}), \
    ...
    def test_edit_module_assignments_zero_hours(self):
        ...
        mod_code_2 = 'AS201'
        mod_code_3 = 'AS301'
        self.client.post(reverse('eduload:add_module',  kwargs={'workloadscenario_id': scenario_1.id}), {'module_code': mod_code_1, 'module_title' : 'module 1', 'total_hours' : '234', 'module_type' : mod_type_1.id, 'semester_offered' : Module.UNASSIGNED, 'students_year_of_study' :2, 'students_year_of_study' :2, 'compulsory_in_primary_programme' : False, 'compulsory_in_secondary_programme':  False, 'compulsory_in_tertiary_programme': False,  'fresh_record' : True})    
        self.client.post(reverse('eduload:add_module',  kwargs={'workloadscenario_id': scenario_1.id}), {'module_code': mod_code_2, 'module_title' : 'module 2', 'total_hours' : '234', 'module_type' : mod_type_1.id, 'semester_offered' : Module.UNASSIGNED, 'students_year_of_study' :2, 'students_year_of_study' :2, 'compulsory_in_primary_programme' : False, 'compulsory_in_secondary_programme':  False, 'compulsory_in_tertiary_programme': False,  'fresh_record' : True})    
        self.client.post(reverse('eduload:add_module',  kwargs={'workloadscenario_id': scenario_1.id}), {'module_code': mod_code_3, 'module_title' : 'module 3', 'total_hours' : '234', 'module_type' : mod_type_1.id, 'semester_offered' : Module.UNASSIGNED, 'students_year_of_study' :2, 'students_year_of_study' :2, 'compulsory_in_primary_programme' : False, 'compulsory_in_secondary_programme':  False, 'compulsory_in_tertiary_programme': False,  'fresh_record' : True})    
        self.assertEqual(Module.objects.all().count(),3)
    ...
    def test_edit_module_assignments_zero_hours_multiple_scenarios(self):
        ...
        assignment_type = TeachingAssignmentType.objects.create(description="hours", quantum_number_of_hours=1,faculty=new_fac)
        self.client.post(reverse('eduload:add_assignment',  kwargs={'workloadscenario_id': scenario_2.id}), {'select_lecturer': normal_lecturer_2.id, 'select_module': module_1_scen_2.id, 'teaching_assignment_type' : assignment_type.id, 'counted_towards_workload' : 'yes','how_many_units':'16'});
        self.client.post(reverse('eduload:add_assignment',  kwargs={'workloadscenario_id': scenario_2.id}), {'select_lecturer': educator_track_2.id, 'select_module': module_3_scen_2.id,'teaching_assignment_type' : assignment_type.id, 'counted_towards_workload' : 'yes','how_many_units':'26'});        
        self.client.post(reverse('eduload:add_assignment',  kwargs={'workloadscenario_id': scenario_2.id}), {'select_lecturer': vice_dean_2.id, 'select_module': module_3_scen_2.id, 'teaching_assignment_type' : assignment_type.id, 'counted_towards_workload' : 'yes','how_many_units':'36'});        
        self.client.post(reverse('eduload:add_assignment',  kwargs={'workloadscenario_id': scenario_2.id}), {'select_lecturer': vice_dean_2.id, 'select_module': module_2_scen_2.id, 'teaching_assignment_type' : assignment_type.id, 'counted_towards_workload' : 'yes','how_many_units':'46'});        
    ...
    def test_teaching_assignments_copied_over(self):
        ...
        self.client.post(reverse('eduload:add_professor',  kwargs={'workloadscenario_id': scenario_1.id}),{'name':'bob','fraction_appointment' : '0.7',    'service_role' : new_role.id, 'employment_track': new_track.id, 'is_external': False,'fresh_record' : True})
        #Add a new module
        mod_code = 'XXX1'
        #Create a module type
        mod_type_1 = ModuleType.objects.create(type_name="TEST_MOD_TYPE", department = first_dept)
        
        self.client.post(reverse('eduload:add_module',  kwargs={'workloadscenario_id': scenario_1.id}), {'module_code': mod_code, 'module_title' : 'testing', 'total_hours' : '234', 'module_type' : mod_type_1.id, 'semester_offered' : Module.UNASSIGNED, 'students_year_of_study' :2, 'compulsory_in_primary_programme' : False, 'compulsory_in_secondary_programme':  False, 'compulsory_in_tertiary_programme': False,  'fresh_record' : True})
        ...
        assignment_type = TeachingAssignmentType.objects.create(description="hours", quantum_number_of_hours=1,faculty=new_fac)
        self.client.post(reverse('eduload:add_assignment',  kwargs={'workloadscenario_id': scenario_1.id}), {'select_lecturer': bob_lecturer.id, 'select_module': module_1.id, 'teaching_assignment_type' : assignment_type.id, 'counted_towards_workload' : 'yes','how_many_units':'16'})
        ...
        self.client.post(reverse('eduload:manage_scenario'), {'label': scen_name_2, 'dept' : first_dept.id, 'status': WorkloadScenario.DRAFT, 'copy_from': scenario_1.id,'fresh_record' : True, 'academic_year' : acad_year.id})
        ...
        response = self.client.post(reverse('eduload:add_professor',  kwargs={'workloadscenario_id': scenario_2.get().id}),{'name':'bob','fraction_appointment' : '0.7',    'service_role' : new_role.id, 'employment_track': new_track.id,'is_external': False, 'fresh_record' : False})
        response = self.client.get(reverse('eduload:scenario_view',  kwargs={'workloadscenario_id': scenario_2.get().id}))
        self.assertEqual(response.status_code, 200) #No issues
        ...
        self.client.post(reverse('eduload:edit_module_assignments', \
    ...
    def test_add_assignment_special_service_role(self):
        ...
        self.client.post(reverse('eduload:add_professor',  kwargs={'workloadscenario_id': first_scen.id}),{'name':'bob','fraction_appointment' : '0.7',    'service_role' : new_role.id,'employment_track': new_track.id, 'is_external': False,'fresh_record' : True})
        self.client.post(reverse('eduload:add_professor',  kwargs={'workloadscenario_id': first_scen.id}),{'name':'ted','fraction_appointment' : '0.5',    'service_role' : new_role_2.id,'employment_track': new_track.id, 'is_external': False,'fresh_record' : True})
        #Add a new module
        mod_code = 'XXX1'
        #Create a module type
        mod_type_1 = ModuleType.objects.create(type_name="TEST_MOD_TYPE", department=first_dept)
        
        self.client.post(reverse('eduload:add_module',  kwargs={'workloadscenario_id': first_scen.id}), {'module_code': mod_code, 'module_title' : 'testing', 'total_hours' : '234', 'module_type' : mod_type_1.id, 'students_year_of_study' :2, 'semester_offered' : Module.UNASSIGNED,  'compulsory_in_primary_programme' : False, 'compulsory_in_secondary_programme':  False, 'compulsory_in_tertiary_programme': False,  'fresh_record' : True})
        ...
        assignment_type = TeachingAssignmentType.objects.create(description="hours", quantum_number_of_hours=1,faculty=new_fac)
        self.client.post(reverse('eduload:add_assignment',  kwargs={'workloadscenario_id': first_scen.id}), {'select_lecturer': bob_lecturer.id,
