...
from decimal import *
from eduload.global_constants import DEFAULT_TRACK_NAME,DEFAULT_SERVICE_ROLE_NAME
from eduload.models import StudentLearningOutcome, ProgrammeOffered, Faculty, Department, Academicyear,WorkloadScenario,EmploymentTrack,ServiceRole,TeachingAssignmentType,\
...
from eduload.report_methods import GetLastNYears,CalculateProfessorIndividualWorkload,CalculateProfessorChartData
from eduload.helper_methods_users import DetermineUserMenu

class TestLecturerPage(TenantTestCase):
    def setup_user(self):
    ...
    def test_lecturer_page(self):
        ...
        response = self.client.get(reverse('eduload:lecturer_page',  kwargs={'lecturer_id': 345}))
        ...
        response = self.client.get(reverse('eduload:lecturer_page',  kwargs={'lecturer_id': anot_lect.id}))
        self.assertEqual(response.status_code, 200) #no issues
