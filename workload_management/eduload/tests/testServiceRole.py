...
from decimal import *
from eduload.models import Lecturer, ServiceRole,WorkloadScenario, EmploymentTrack, UniversityStaff,Faculty, Department, Academicyear

class TestServiceRole(TenantTestCase):
    def setup_user(self):
    ...
    def test_add_remove_role(self):
        ...
        role_adj = 0.5
        self.client.post(reverse('eduload:school_page' ,  kwargs={'faculty_id': new_fac.id}),{'role_name':new_role_name,'role_adjustment' : str(role_adj), 'fresh_record': True})
        ...
        self.client.post(reverse('eduload:school_page', kwargs={'faculty_id': new_fac.id}),{'select_service_role_to_remove':new_role.get().id})
    ...
    def test_edit_existing_role(self):
        ...
        new_role_adj = 0.8
        self.client.post(reverse('eduload:school_page', kwargs={'faculty_id': new_fac.id}),{'role_name':new_role_name,'role_adjustment' : str(new_role_adj),\
    ...
    def test_same_role_name(self):
        ...
        new_role_adj = 0.8
        self.client.post(reverse('eduload:school_page', kwargs={'faculty_id': new_fac.id}),{'role_name':new_role_name,'role_adjustment' : str(new_role_adj), 'fresh_record': True})
        ...
        new_adj = 0.8
        self.client.post(reverse('eduload:school_page', kwargs={'faculty_id': new_fac.id}),{'role_name':valid_name,'role_adjustment' : str(new_adj), 'fresh_record': True})
        ...
        self.client.post(reverse('eduload:school_page', kwargs={'faculty_id': new_fac.id}),{'role_name':new_role_name,'role_adjustment' : str(new_adj), \
                                 'fresh_record': False,
    ...
    def test_add_remove_service_role_with_lecturer(self):
        ...
        self.client.post(reverse('eduload:school_page', kwargs={'faculty_id': new_fac.id}),{'select_service_role_to_remove':new_role.id})
    ...
    def test_edit_lecturer_change_role(self):
        ...
        role_adj_2 = 9
        self.client.post(reverse('eduload:school_page', kwargs={'faculty_id': new_fac.id}),{'role_name':new_role_name_2,'role_adjustment' : str(role_adj_2), 'fresh_record': True})
        ...
        self.assertEqual(Lecturer.objects.all().count(),0)
        #Add a lecturer on this service role
        self.client.post(reverse('eduload:add_professor',  kwargs={'workloadscenario_id': new_scen.id}),{'name':'bob','fraction_appointment' : '0.5',  'employment_track': def_track.id, 'service_role' : new_role.get().id,\
    ...
    def test_add_remove_role_with_lecturer_multiple_scen(self):
        ...
        role_adj = 0.5
        self.client.post(reverse('eduload:school_page', kwargs={'faculty_id': new_fac.id}),{'role_name':new_role_name,'role_adjustment' : str(role_adj), 'fresh_record': True})
        self.client.post(reverse('eduload:school_page', kwargs={'faculty_id': new_fac.id} ),{'role_name':new_role_name_2,'role_adjustment' : str(role_adj), 'fresh_record': True})
        new_role = ServiceRole.objects.filter(role_name = new_role_name)
        new_role_2 = ServiceRole.objects.filter(role_name = new_role_name_2)
