...
from decimal import *
from workload_app.models import Academicyear, Lecturer, Module, \
...
class TestWorkloadScenarios(TestCase):
    ...
    def test_add_remove_scenario_forms(self):
        ...
        self.client.post(reverse('workload_app:add_module', kwargs={'workloadscenario_id': new_scenario.get().id}), {
        ...
        self.client.post(reverse('workload_app:add_assignment',  kwargs={'workloadscenario_id': new_scenario.get().id}), data = {'select_lecturer': normal_lecturer.id, \
    ...
    def test_manage_scenario(self):
        ...
        self.client.post(reverse('workload_app:add_module', kwargs={'workloadscenario_id': first_scenario.id}), {'module_code': mod_code_1, 'module_title' : 'testing', 'total_hours' : '2340', 'module_type' : mod_type_1.id, 'semester_offered' : Module.UNASSIGNED,  'students_year_of_study' :2, 'compulsory_in_primary_programme' : False, 'compulsory_in_secondary_programme':  False, 'compulsory_in_tertiary_programme': False,  'fresh_record' : True})    
        self.client.post(reverse('workload_app:add_module', kwargs={'workloadscenario_id': first_scenario.id}), {'module_code': mod_code_2, 'module_title' : 'testing2', 'total_hours' : '234', 'module_type' : mod_type_1.id, 'semester_offered' : Module.UNASSIGNED,  'students_year_of_study' :2, 'compulsory_in_primary_programme' : False, 'compulsory_in_secondary_programme':  False, 'compulsory_in_tertiary_programme': False,  'fresh_record' : True})    
        self.client.post(reverse('workload_app:add_module', kwargs={'workloadscenario_id': first_scenario.id}), {'module_code': mod_code_3, 'module_title' : 'testing3', 'total_hours' : '234', 'module_type' : mod_type_1.id, 'semester_offered' : Module.UNASSIGNED,  'students_year_of_study' :2, 'compulsory_in_primary_programme' : False, 'compulsory_in_secondary_programme':  False, 'compulsory_in_tertiary_programme': False,  'primary_programme' : first_prog.id, 'fresh_record' : True})    
        ...
        self.client.post(reverse('workload_app:add_assignment',  kwargs={'workloadscenario_id': first_scenario.id}), data = {'select_lecturer': normal_lecturer.id, \
        ...
        self.client.post(reverse('workload_app:add_assignment',  kwargs={'workloadscenario_id': first_scenario.id}), data = {'select_lecturer': educator_track.id, \
