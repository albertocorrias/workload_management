...
class testHelperMethods(TestCase):
    ...
    def test_workload_tables(self):
        ...
        #create a Programme
        prog_name = "test prog"
        prog = ProgrammeOffered.objects.create(programme_name = prog_name, primary_dept = Department.objects.filter(department_name = DEFAULT_DEPARTMENT_NAME).get())
        ...
        #########################################################
        #Check the list of lecturers table generated by the helper method (redundnat, but we leave it here)
        #########################################################
    ...
    def test_module_table_with_long_module_name(self):
        ...
        mod_type_1 = ModuleType.objects.create(type_name="Core")
        mod_code_1 = 'AS101'
    ...
    def testCalculateModuleTableOverYears(self):
        ...
        self.assertEqual(calc[0]["primary_programme"],"")
        ...
        self.assertEqual(calc[0]["module_type"],"one type")
        self.assertEqual(calc[0]["semester_offered"],"Semester 1")
        self.assertEqual(calc[0]["primary_programme"],programme_2.programme_name)
        self.assertEqual(calc[0]["secondary_programme"],"")
        self.assertEqual(calc[0]["primary_subprogramme"],"")
        self.assertEqual(calc[0]["secondary_subprogramme"],"")
        ...
        self.assertEqual(calc[0]["module_type"],"one type")
        self.assertEqual(calc[0]["semester_offered"],"Semester 1")
        self.assertEqual(calc[0]["primary_programme"],programme_1.programme_name)
        ...
        self.assertEqual(calc[1]["primary_programme"],programme_1.programme_name)
        self.assertEqual(calc[1]["secondary_programme"],programme_2.programme_name)
        self.assertEqual(calc[1]["primary_subprogramme"],sub_programme_1.sub_programme_name)
        self.assertEqual(calc[1]["secondary_subprogramme"],"")
    ...
    def testCalculateServiceRolesTable(self):
        ...
        self.assertEqual(len(tbl),0)
        ServiceRole.objects.create(role_name = "role_1", role_adjustment = 2)
